...
def get_pending_months(raw_dir, interim_dir, source_name, overwrite=False):
    ...
    Si overwrite=True, devuelve todos los meses de raw (no solo pendientes).
    ...
    Args:
        ...
        overwrite: si True, devuelve todos los meses de raw (reprocesar todo)

    Returns:
        Lista de tuplas (year, month) pendientes (o todos si overwrite=True)
    """
